...
const Footer = () => {
  ...
  return (
    <div>
      <footer
        className={`p-5 text-white text-center position-relative ${styles.footertxt}`}
      >
        <div className="continer">
          <footer className="page-footer font-small special-color-dark pt-4">
            <div className="row">
              ...
              >
                <img
                  src="assets/images/logo down.png"
                  alt="footer-logo"
                  width="140px"
                  height="200px"
                />
                ...
                <div className="col-md-12">
                  <div className="row">
                    <div className="col-md-9">
                      <h6 className={`mt-4 d-flex justify-content-start mb-0`}>
                        Your email
                      </h6>
                    ...
                    <div className="col-md-2 mt-5">
                      <div className="input-group-append">
                        <button
                          className={`btn btn-sm btn-outline-dark text-white my-0 ${styles.footerbtntxt}`}
                          type="button"
                        >
                          Join
                        </button>
              ...
              >
                <h6
                  className={`${styles.footHead} ${styles.aboutColumn} ${styles.fontsStyle}`}
                >
                  Know Your Jewellwry
                </h6>
      ...
      <div
        className={`col-md-12 text-center text-white ${styles.footercolumn}`}
      >
        <p className={`${styles.foottext}`}>
          {" "}
          &copy; LUXURY GOLD. All rights reserved
        </p>
