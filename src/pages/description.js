            ...
            <div className="container">
                <div className={`${styles.space} row`}>
                    ...
                    <div className="col-md-6">
                        ...
                        <p className={`${styles.txtcolor}`}>We work with the vision of offering tastefully designed jewellery at revolutionary prices. This is
                ...
                <div className="container">
                    <div className={`${styles.space} row`}>
                        ...
                        <div className="col-md-8">
                            <h1 className={`${styles.gallerytxt1} pt-5 container`} >Our <span className={`${styles.gallerytxt}`} >Story</span></h1>
                            <p className={`${styles.txtcolor}`}>We began in 2008 with the simple motto of democratising jewellery. And today, after 10 glorious years,
                ...
                <div className={`${styles.space} row`}>
                    ...
                    <div className="col-md-6 mt-5">
                        <div className="col-md-12">
                            ...
                            <p className={`${styles.txtcolor1}`}>We always find ways to show our affection to our loved ones. Making a special moment even more special needs a
                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <p className={`${styles.txtcolor1}`}>
                                        ...
                                        neither get the benefit of the entire range as it won’t be feasible.
                                    </p>
                                </div>
                                <div className="col-md-4">
                                    <img
